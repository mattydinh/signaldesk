    ...
    <div className="min-h-screen gradient-mesh flex flex-col items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/intelligence"
            className="inline-flex items-center justify-center rounded-badge border border-[#3F3F46] bg-[#27272A] px-8 py-3 text-body font-semibold text-foreground hover:bg-[#3F3F46] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-colors duration-150"
          >
            Intelligence
          </Link>
        </div>
