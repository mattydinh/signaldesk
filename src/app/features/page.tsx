      ...
      <main id="main" className="mx-auto max-w-feed px-4 py-16 sm:px-6 lg:px-8">
        <section className="mb-16" aria-labelledby="features-heading">
          ...
          <p className="mt-2 text-body text-[#A1A1AA]">
            Documentation for SignalDesk features in beta, including the ML pipeline that powers Intelligence.
          </p>
        </section>

        <section className="space-y-8 rounded-card border border-[#27272A] bg-[#18181B]/40 p-8" aria-labelledby="ml-pipeline-heading">
          <h2 id="ml-pipeline-heading" className="text-section-header text-foreground">
          ...
          <div>
            <h3 className="text-foreground font-medium mb-2">What kind of NLP it is</h3>
          ...
          <div>
            <h3 className="text-foreground font-medium mb-2">Pipeline steps (high level)</h3>
          ...
          <div>
            <h3 className="text-foreground font-medium mb-2">Why features can have statistical significance together</h3>
            <ul className="list-inside list-disc space-y-2 text-body text-[#A1A1AA]">
          ...
          <div>
            <h3 className="text-foreground font-medium mb-2">Why the signals could do well logically</h3>
            <ul className="list-inside list-disc space-y-2 text-body text-[#A1A1AA]">
